...
class RequestOutput:
    ...
    def __init__(
        ...
        latent_internal_token_count: int = 0,
        *,
        ...
        **kwargs: Any,
        ...
        self.latent_internal_token_count = latent_internal_token_count
    ...
    def __repr__(self) -> str:
        return (
            ...
            f"latent_internal_token_count={self.latent_internal_token_count})"
        )
